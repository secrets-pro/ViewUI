                        ...
                        if (this.showWithSpan(row, column, index, colIndex)) {
                            const $tableCell = h(TableCell, {
                                props: {
                                    ...
                                    "natural-index": index,
                                    index: row._index,
                                    checked: this.rowStatusByRowKey(
                                        "_isChecked",
                                        row._rowKey
                                    ),
                                    disabled: this.rowStatusByRowKey(
                                        "_isDisabled",
                                        row._rowKey
                                    ),
                                    expanded: this.rowStatusByRowKey(
                                        "_isExpanded",
                                        row._rowKey
                                    ),
                                    treeNode: true,
            ...
            const $tableTr = h(
                TableTr,
                {
                    ...
                    nativeOn: {
                        ...
                        contextmenu: e =>
                            this.contextmenuCurrentRow(row._index, e),
                        selectstart: e =>
                            this.selectStartCurrentRow(row._index, e)
                    }
                },
                $tds
            );
