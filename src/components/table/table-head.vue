            ...
            <tr v-for="(cols, rowIndex) in headRows">
                ...
                >
                    <div :class="cellClasses(column)">
                        ...
                        <template
                            v-else-if="
                                column.type === 'selection' && column.show
                            "
                            ><Checkbox
                                :value="isSelectAll"
                        ...
                        <template v-else>
                            ...
                            <Poptip
                                ...
                                v-model="
                                    getColumn(rowIndex, index)._filterVisible
                                "
                                placement="bottom"
            ...
            if (objData.children && objData.children.length) {
                objData.children.forEach(row => {
                    if (!(row._isDisabled && !row._isChecked)) {
                        ...
                        status = this.isChildrenAllDisabledAndUnSelected(
                            row,
                            status
                        );
                    }
